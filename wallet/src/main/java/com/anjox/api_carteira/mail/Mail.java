package com.anjox.api_carteira.mail;
...
public class Mail {
    ...
    public void send(UserEntity user) throws MessagingException, UnsupportedEncodingException {
        String toAddres = user.getEmail();
        String fromAdders = "meu email/ email da empresa";
        String senderName = "nome do site ou da empresa";
        ...
        helper.setFrom(fromAdders, senderName);
        helper.setTo(toAddres);
        helper.setSubject(subject);

        content = content.replace("[[NAME]]", user.getUsername());

        String verifyURL = this.link + user.getToken();
